...
public class MenuPanel extends JPanel{
    ...
    public JButton bPlayB = new JButton("Jouer IA Bleu");
    public JButton bPlayR = new JButton("Jouer IA Rouge");
    ...
    MenuPanel(HexModel model){
        ...
        bPlayB.setSize(bWidth,bHeight);
        bPlayR.setSize(bWidth,bHeight);
        bReset.setSize(bWidth,bHeight);
        bQuit.setSize(bWidth,bHeight);

        bPanel.add(bPlayR, BorderLayout.NORTH);
        bPanel.add(bPlayB, BorderLayout.EAST);
    ...
    public void paint(Graphics g) {
        ...
        if (!this.model.getCurrentGame()){
            bPlayB.setText("Jouer IA Bleu");
            bPlayR.setText("Jouer IA Rouge");
            bReset.setVisible(false);
        }
        else{
            bPlayB.setText("Reprendre");
            bPlayR.setVisible(false);
